...
See [the Code documentation]({% link docs/jtd/ui-components/code.md %}#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Navigation Structure]({% link docs/jtd/navigation-structure.md %}#external-navigation-links) for more details.
...
See [Customization]({% link docs/jtd/customization.md %}) for more information.
...
See [Callouts]({% link docs/jtd/ui-components/callouts.md %}) for more information.
